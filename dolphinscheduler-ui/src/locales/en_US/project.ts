...
export default {
  ...
  workflow: {
    ...
    schedule_date_tips: "The format is yyyy-MM-dd HH:mm:ss with multiple comma splits",
  ...
  node: {
    ...
    hive_cli_options_tips: "Please enter the options for hive cli, e.g. --verbose",
    ...
    mlflow_mlflowTrackingUri_error_tips: "MLflow Tracking Server URI can not be empty",
